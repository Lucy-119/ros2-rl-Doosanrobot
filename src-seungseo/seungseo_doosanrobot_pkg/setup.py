...
package_name = 'seungseo_doosanrobot_pkg'
...
setup(
    ...
    entry_points={
        'console_scripts': [
                'trajectory_points_topic = seungseo_doosanrobot_pkg.joint_points_topic:main',
                'trajectory_points_act_server = seungseo_doosanrobot_pkg.joint_points_act_service:main',
        ],
    },
)
