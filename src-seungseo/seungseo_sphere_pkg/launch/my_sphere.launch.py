...
Describer:  This script lauchs (spawn) the sphere in gazebo using a sdf file. 
            ...
            the sdf could be found in /src/seungseo_sphere_pkg/models/sdf/sphere_goal
...
def generate_launch_description():
    ...
    pkg_dir = get_package_share_directory('seungseo_sphere_pkg') 
    ...
    spawn_entity = Node(package='gazebo_ros', 
                        ...
                        arguments=['-entity', 'seungseo_sphere', '-file', sdf, '-x','0.5', '-y','0.5', '-z','1'], 
                        output='screen')

    # Nodes
    # node_mark --> coordinate_node.py --> reads the position of the sphere in Gazebo and publishes the Marker Topic 
    
    node_mark = Node(package ='seungseo_sphere_pkg', executable ='reader_mark_node', output ='screen')
